...
class RUN_stats():
    ...
    def __init__(self, all_vars):
        ...
        regression_param  = self.project_vars['regression_param']
        other_params      = self.project_vars['other_params']
        ...
        print(f'    Performing statistical analysis in folder: {self.stats_paths["STATS_HOME"]}')
