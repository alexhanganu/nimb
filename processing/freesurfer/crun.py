...
import time, shutil
from var import (nimb_dir, nimb_scratch_dir, SUBJECTS_DIR, processed_SUBJECTS_DIR,
                processing_env, max_nr_running_batches, batch_walltime, submit_cmd, archive_processed,
                freesurfer_version, process_order, base_name, DO_LONG)
