...
# def queue(process, all_running): version 2020-03-03
# has an ERROR: when subjid is sent to registration, sbatch can start the registration, status changes to R
# but subjid is not reigstered yet, and the loop returns an error that stops the pipeline
#     ACTION = 'QUEUE'
#     cdb.Update_status_log(ACTION+' '+process)
