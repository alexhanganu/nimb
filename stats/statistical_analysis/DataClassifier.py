...
class DataClassifier:
    ...
    def run(self):
        ...
        for _id in main_indexs:
            ...
            count += 1
            self.Classification_dict[sub_id] = {'ses-1': {'anat': {}}}

            self.send_to_dictionnary(sub_id, 'ses-1', main_idx_value)
            ...
            for tp in additional_tps:
                ...
                for _id in main_indexs:
                    ...
                    if _id in data_indexs:
                        ...
                        tp_label = 'tp' + str(len(self.Classification_dict[subjects_id[_id]]))

                        self.Classification_dict[subjects_id[_id]][tp_label]['anat'] = {}
    ...
    def send_to_dictionnary(self, _id, tp_label, obj):
        ...
        self.Classification_dict[_id][tp_label]['anat'] = tp_obj
